...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/FreeRTOS_Timer_Interrupts_should_generate_first_timer_interrupt_at_correct_time/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 7 : value = dut->io_timer_mtip; break;
      case 8 : value = dut->io_timer_mtime; break;
      case 9 : value = dut->io_timer_mtimecmp; break;
      case 10 : value = dut->io_uart_tx; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/FreeRTOS_Timer_Interrupts_should_generate_first_timer_interrupt_at_correct_time/FreeRTOSTestTop.)";
