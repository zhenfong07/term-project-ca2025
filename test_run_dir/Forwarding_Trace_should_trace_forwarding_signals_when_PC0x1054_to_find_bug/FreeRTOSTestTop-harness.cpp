...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/Forwarding_Trace_should_trace_forwarding_signals_when_PC0x1054_to_find_bug/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/Forwarding_Trace_should_trace_forwarding_signals_when_PC0x1054_to_find_bug/FreeRTOSTestTop.fst)";
