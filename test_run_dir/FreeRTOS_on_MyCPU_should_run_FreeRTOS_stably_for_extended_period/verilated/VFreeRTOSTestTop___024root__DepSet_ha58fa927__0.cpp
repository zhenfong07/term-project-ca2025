...
VL_INLINE_OPT void VFreeRTOSTestTop___024root___nba_sequent__TOP__0(VFreeRTOSTestTop___024root* vlSelf) {
    ...
    SData/*12:0*/ __Vdlyvdim0__FreeRTOSTestTop__DOT__mem__DOT__mem_3__v0;
        ...
        = ((1U & (~ (IData)(vlSelf->reset))) && ((1U 
                                                  & (~ 
                                                     ((IData)(vlSelf->FreeRTOSTestTop__DOT__dummy__DOT__write_data_ok) 
                                                      & (IData)(vlSelf->FreeRTOSTestTop__DOT__dummy_io_channels_write_response_channel_BREADY)))) 
    ...
    if (vlSelf->reset) {
        ...
        if ((0x1513U >= vlSelf->FreeRTOSTestTop__DOT__rom_loader__DOT__address)) {
            __Vdly__FreeRTOSTestTop__DOT__rom_loader__DOT__address 
...
#endif
            VL_FATAL_MT("FreeRTOSTestTop.sv", 10433, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("FreeRTOSTestTop.sv", 10433, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("FreeRTOSTestTop.sv", 10433, "", "Active region did not converge.");
            }
...
void VFreeRTOSTestTop___024root___eval_debug_assertions(VFreeRTOSTestTop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelf->io_external_interrupt 
                     & 0xfeU))) {
        Verilated::overWidthError("io_external_interrupt");}
}
#endif  // VL_DEBUG
