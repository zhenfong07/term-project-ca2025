...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/harrypotter/term-project-ca2025-main/test_run_dir/FreeRTOS_on_MyCPU_should_run_FreeRTOS_stably_for_extended_period/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 4 : dut->io_external_interrupt = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 4 : value = dut->io_external_interrupt; break;
      case 5 : value = dut->io_regs_debug_read_data; break;
      case 6 : value = dut->io_mem_debug_read_data; break;
      case 7 : value = dut->io_csr_debug_read_data; break;
      case 8 : value = dut->io_timer_mtime; break;
      case 9 : value = dut->io_timer_mtimecmp; break;
      case 10 : value = dut->io_timer_mtip; break;
      case 11 : value = dut->io_uart_txd; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/harrypotter/term-project-ca2025-main/test_run_dir/FreeRTOS_on_MyCPU_should_run_FreeRTOS_stably_for_extended_period/FreeRTOSTestTop.)";
