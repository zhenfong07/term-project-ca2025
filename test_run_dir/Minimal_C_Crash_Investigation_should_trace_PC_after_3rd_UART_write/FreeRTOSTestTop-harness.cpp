...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/Minimal_C_Crash_Investigation_should_trace_PC_after_3rd_UART_write/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/Minimal_C_Crash_Investigation_should_trace_PC_after_3rd_UART_write/FreeRTOSTestTop.)";
