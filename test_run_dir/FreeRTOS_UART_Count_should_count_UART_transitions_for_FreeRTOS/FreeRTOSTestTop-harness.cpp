...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/FreeRTOS_UART_Count_should_count_UART_transitions_for_FreeRTOS/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/FreeRTOS_UART_Count_should_count_UART_transitions_for_FreeRTOS/FreeRTOSTestTop.)";
