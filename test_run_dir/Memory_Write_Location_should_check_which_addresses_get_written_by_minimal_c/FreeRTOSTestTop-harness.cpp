...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/Memory_Write_Location_should_check_which_addresses_get_written_by_minimal_c/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 9 : value = dut->io_timer_mtip; break;
      case 10 : value = dut->io_timer_mtime; break;
      case 11 : value = dut->io_timer_mtimecmp; break;
      case 12 : value = dut->io_uart_tx; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/Memory_Write_Location_should_check_which_addresses_get_written_by_minimal_c/FreeRTOSTestTop.)";
