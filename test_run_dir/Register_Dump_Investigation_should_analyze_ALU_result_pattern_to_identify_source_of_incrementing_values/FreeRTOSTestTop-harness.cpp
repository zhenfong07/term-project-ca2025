...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/Register_Dump_Investigation_should_analyze_ALU_result_pattern_to_identify_source_of_incrementing_values/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 15 : value = dut->io_timer_mtip; break;
      case 16 : value = dut->io_timer_mtime; break;
      case 17 : value = dut->io_timer_mtimecmp; break;
      case 18 : value = dut->io_uart_tx; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/Register_Dump_Investigation_should_analyze_ALU_result_pattern_to_identify_source_of_incrementing_values/FreeRTOSTestTop.fst)";
