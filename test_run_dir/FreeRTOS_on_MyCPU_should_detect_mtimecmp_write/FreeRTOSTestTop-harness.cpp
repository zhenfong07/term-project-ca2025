...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/harrypotter/term-project-ca2025-main/test_run_dir/FreeRTOS_on_MyCPU_should_detect_mtimecmp_write/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/harrypotter/term-project-ca2025-main/test_run_dir/FreeRTOS_on_MyCPU_should_detect_mtimecmp_write/FreeRTOSTestTop.)";
