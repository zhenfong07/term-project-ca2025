...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/ALU_Result_vs_Bus_Address_should_compare_alu_result_and_bus_address_at_PC0x1054/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 10 : value = dut->io_timer_mtip; break;
      case 11 : value = dut->io_timer_mtime; break;
      case 12 : value = dut->io_timer_mtimecmp; break;
      case 13 : value = dut->io_uart_tx; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/ALU_Result_vs_Bus_Address_should_compare_alu_result_and_bus_address_at_PC0x1054/FreeRTOSTestTop.)";
