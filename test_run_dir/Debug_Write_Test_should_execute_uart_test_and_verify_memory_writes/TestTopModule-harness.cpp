...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/phong/Term-project-CA2025/4-soc/test_run_dir/Debug_Write_Test_should_execute_uart_test_and_verify_memory_writes/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/phong/Term-project-CA2025/4-soc/test_run_dir/Debug_Write_Test_should_execute_uart_test_and_verify_memory_writes/TestTopModule.)";
