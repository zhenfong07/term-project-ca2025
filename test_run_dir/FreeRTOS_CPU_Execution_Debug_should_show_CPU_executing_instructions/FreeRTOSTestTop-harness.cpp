...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/FreeRTOS_CPU_Execution_Debug_should_show_CPU_executing_instructions/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/FreeRTOS_CPU_Execution_Debug_should_show_CPU_executing_instructions/FreeRTOSTestTop.)";
