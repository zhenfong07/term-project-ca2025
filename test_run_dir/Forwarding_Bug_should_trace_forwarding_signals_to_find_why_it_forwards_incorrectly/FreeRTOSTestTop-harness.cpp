...
#define TOP_CLASS VFreeRTOSTestTop
...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/Forwarding_Bug_should_trace_forwarding_signals_to_find_why_it_forwards_incorrectly/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 3 : dut->io_csr_debug_read_address = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 3 : value = dut->io_csr_debug_read_address; break;
      case 4 : value = dut->io_regs_debug_read_data; break;
      case 5 : value = dut->io_mem_debug_read_data; break;
      case 6 : value = dut->io_csr_debug_read_data; break;
      case 7 : value = dut->io_bus_address; break;
      case 8 : value = dut->io_instruction_address; break;
      case 9 : value = dut->io_alu_result_mem; break;
      case 10 : value = dut->io_cpu_pc; break;
      case 11 : value = dut->io_debug_reg_sp; break;
      case 12 : value = dut->io_debug_reg_a2; break;
      case 13 : value = dut->io_debug_reg_a3; break;
      case 14 : value = dut->io_debug_reg_a5; break;
      case 15 : value = dut->io_debug_reg1_forward_ex; break;
      case 16 : value = dut->io_debug_rs1_ex; break;
      case 17 : value = dut->io_debug_rd_mem; break;
      case 18 : value = dut->io_debug_reg_write_enable_mem; break;
      case 19 : value = dut->io_mem_stall_flag; break;
      case 20 : value = dut->io_timer_mtip; break;
      case 21 : value = dut->io_timer_mtime; break;
      case 22 : value = dut->io_timer_mtimecmp; break;
      case 23 : value = dut->io_uart_tx; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/fret/Bureau/exchange-NCKU/computer_Architecture/term-project-ca2025/test_run_dir/Forwarding_Bug_should_trace_forwarding_signals_to_find_why_it_forwards_incorrectly/FreeRTOSTestTop.)";
