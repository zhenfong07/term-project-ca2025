...
class alignas(VL_CACHE_LINE_BYTES) VFreeRTOSTestTop VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    VL_OUT8(&io_debug_reg1_forward_ex,1,0);
    VL_OUT8(&io_debug_rs1_ex,4,0);
    VL_OUT8(&io_debug_rd_mem,4,0);
    VL_OUT8(&io_debug_reg_write_enable_mem,0,0);
    VL_OUT8(&io_mem_stall_flag,0,0);
    ...
    VL_OUT(&io_bus_address,31,0);
    VL_OUT(&io_instruction_address,31,0);
    VL_OUT(&io_alu_result_mem,31,0);
    VL_OUT(&io_cpu_pc,31,0);
    VL_OUT(&io_debug_reg_sp,31,0);
    VL_OUT(&io_debug_reg_a2,31,0);
    VL_OUT(&io_debug_reg_a3,31,0);
    VL_OUT(&io_debug_reg_a5,31,0);
