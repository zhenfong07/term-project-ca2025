...
VFreeRTOSTestTop::VFreeRTOSTestTop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , io_debug_reg1_forward_ex{vlSymsp->TOP.io_debug_reg1_forward_ex}
    , io_debug_rs1_ex{vlSymsp->TOP.io_debug_rs1_ex}
    , io_debug_rd_mem{vlSymsp->TOP.io_debug_rd_mem}
    , io_debug_reg_write_enable_mem{vlSymsp->TOP.io_debug_reg_write_enable_mem}
    , io_mem_stall_flag{vlSymsp->TOP.io_mem_stall_flag}
