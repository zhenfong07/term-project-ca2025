...
VL_INLINE_OPT void VFreeRTOSTestTop___024root___nba_sequent__TOP__0(VFreeRTOSTestTop___024root* vlSelf) {
    ...
    if (vlSelf->reset) {
        ...
        if ((0xaU >= vlSelf->FreeRTOSTestTop__DOT__rom_loader__DOT__address)) {
            __Vdly__FreeRTOSTestTop__DOT__rom_loader__DOT__address 
...
#endif
            VL_FATAL_MT("FreeRTOSTestTop.sv", 10546, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("FreeRTOSTestTop.sv", 10546, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("FreeRTOSTestTop.sv", 10546, "", "Active region did not converge.");
            }
